/* Slowpoke - 18/02/2019 11:17:36 GMT */
/*
...
!1)})),b)},valid:function(){var a,b;return c(this[0]).is("form")?a=this.validate().form():(a=!0,b=c(this[0].form).validate(),this.each(function(){a=b.element(this)&&a})),a},removeAttrs:function(a){var b={},d=this;return c.each(a.split(/\s/),function(a,c){b[c]=d.attr(c);d.removeAttr(c)}),b},rules:function(a,b){var d,e,g,f,k,l,h=this[0];if(a)switch(d=c.data(h.form,"validator").settings,e=d.rules,g=c.validator.staticRules(h),a){case "add":c.extend(g,c.validator.normalizeRule(b));delete g.messages;e[h.name]=
g;b.messages&&(d.messages[h.name]=c.extend(d.messages[h.name],b.messages));break;case "remove":return b?(l={},c.each(b.split(/\s/),function(a,b){l[b]=g[b];delete g[b];"required"===b&&c(h).removeAttr("aria-required")}),l):(delete e[h.name],g)}return f=c.validator.normalizeRules(c.extend({},c.validator.classRules(h),c.validator.attributeRules(h),c.validator.dataRules(h),c.validator.staticRules(h)),h),f.required&&(k=f.required,delete f.required,f=c.extend({required:k},f),c(h).attr("aria-required","true")),
f.remote&&(k=f.remote,delete f.remote,f=c.extend(f,{remote:k})),f}});c.extend(c.expr[":"],{blank:function(a){return!c.trim(""+c(a).val())},filled:function(a){return!!c.trim(""+c(a).val())},unchecked:function(a){return!c(a).prop("checked")}});c.validator=function(a,b){this.settings=c.extend(!0,{},c.validator.defaults,a);this.currentForm=b;this.init()};c.validator.format=function(a,b){return 1===arguments.length?function(){var b=c.makeArray(arguments);return b.unshift(a),c.validator.format.apply(this,
...
this.toHide=this.errorsFor(a)},elementValue:function(a){var b;a=c(a);var d=a.attr("type");return"radio"===d||"checkbox"===d?c("input[name='"+a.attr("name")+"']:checked").val():(b=a.val(),"string"==typeof b?b.replace(/\r/g,""):b)},check:function(a){a=this.validationTargetFor(this.clean(a));var b,d,e=c(a).rules(),g=c.map(e,function(a,b){return b}).length,f=!1,k=this.elementValue(a);for(d in e){var l={method:d,parameters:e[d]};try{if(b=c.validator.methods[d].call(this,k,a,l.parameters),"dependency-mismatch"===
b&&1===g)f=!0;else{if(f=!1,"pending"===b)return void(this.toHide=this.toHide.not(this.errorsFor(a)));if(!b)return this.formatAndAdd(a,l),!1}}catch(h){throw this.settings.debug&&window.console&&console.log("Exception occurred when checking element "+a.id+", check the '"+l.method+"' method.",h),h;}}if(!f)return this.objectLength(e)&&this.successList.push(a),!0},customDataMessage:function(a,b){return c(a).data("msg"+b[0].toUpperCase()+b.substring(1).toLowerCase())||c(a).data("msg")},customMessage:function(a,
...
b){a.constructor===String?this.classRuleSettings[a]=b:c.extend(this.classRuleSettings,a)},classRules:function(a){var b={};a=c(a).attr("class");return a&&c.each(a.split(" "),function(){this in c.validator.classRuleSettings&&c.extend(b,c.validator.classRuleSettings[this])}),b},attributeRules:function(a){var b,d,e={},g=c(a),f=a.getAttribute("type");for(b in c.validator.methods)"required"===b?(d=a.getAttribute(b),""===d&&(d=!0),d=!!d):d=g.attr(b),/min|max/.test(b)&&(null===f||/number|range|text/.test(f))&&
(d=Number(d)),d||0===d?e[b]=d:f===b&&"range"!==f&&(e[b]=!0);return e.maxlength&&/-1|2147483647|524288/.test(e.maxlength)&&delete e.maxlength,e},dataRules:function(a){var b,d={},e=c(a);for(b in c.validator.methods)a=e.data("rule"+b[0].toUpperCase()+b.substring(1).toLowerCase()),void 0!==a&&(d[b]=a);return d},staticRules:function(a){var b={},d=c.data(a.form,"validator");return d.settings.rules&&(b=c.validator.normalizeRule(d.settings.rules[a.name])||{}),b},normalizeRules:function(a,b){return c.each(a,
function(d,e){if(!1===e)return void delete a[d];if(e.param||e.depends){var g=!0;switch(typeof e.depends){case "string":g=!!c(e.depends,b.form).length;break;case "function":g=e.depends.call(b,b)}g?a[d]=void 0!==e.param?e.param:!0:delete a[d]}}),c.each(a,function(d,e){a[d]=c.isFunction(e)?e(b):e}),c.each(["minlength","maxlength"],function(){a[this]&&(a[this]=Number(a[this]))}),c.each(["rangelength","range"],function(){var b;a[this]&&(c.isArray(a[this])?a[this]=[Number(a[this][0]),Number(a[this][1])]:
...
this.settings.messages[b.name].remote=f.message,d="string"==typeof d&&{url:d}||d,f.old===a?f.valid:(f.old=a,e=this,this.startRequest(b),g={},g[b.name]=a,c.ajax(c.extend(!0,{url:d,mode:"abort",port:"validate"+b.name,dataType:"json",data:g,context:e.currentForm,success:function(d){var g,h,k,m=!0===d||"true"===d;e.settings.messages[b.name].remote=f.originalMessage;m?(k=e.formSubmitted,e.prepareElement(b),e.formSubmitted=k,e.successList.push(b),delete e.invalid[b.name],e.showErrors()):(g={},h=d||e.defaultMessage(b,
"remote"),g[b.name]=f.message=c.isFunction(h)?h(a):h,e.invalid[b.name]=!0,e.showErrors(g));f.valid=m;e.stopRequest(b,m)}},d)),"pending")}}});c.format=function(){throw"$.format has been deprecated. Please use $.validator.format instead.";}}(jQuery);
(function(c){var a,b={};c.ajaxPrefilter?c.ajaxPrefilter(function(a,c,g){c=a.port;"abort"===a.mode&&(b[c]&&b[c].abort(),b[c]=g)}):(a=c.ajax,c.ajax=function(d){var e=("port"in d?d:c.ajaxSettings).port;return"abort"===("mode"in d?d:c.ajaxSettings).mode?(b[e]&&b[e].abort(),b[e]=a.apply(this,arguments),b[e]):a.apply(this,arguments)})})(jQuery);(function(c){c.extend(c.fn,{validateDelegate:function(a,b,d){return this.bind(b,function(b){var e=c(b.target);return e.is(a)?d.apply(e,arguments):void 0})}})})(jQuery);
$.validator.addMethod("cpf",function(c,a){var b=c.replace(/[^0-9]/gi,"");if(11>b.length)b=!1;else{var d;var e=b.substring(0,9);var g=b.substring(9);var f=0;for(d=10;1<d;d--)f+=e.charAt(10-d)*d;if((2>f%11?0:11-f%11)!=g.charAt(0))b=!1;else{e=b.substring(0,10);f=0;for(d=11;1<d;d--)f+=e.charAt(11-d)*d;b=(2>f%11?0:11-f%11)!=g.charAt(1)?!1:!0}}return b},"Informe um CPF v\u00e1lido.");