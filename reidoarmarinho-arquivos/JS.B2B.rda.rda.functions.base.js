...
try {
	/* COMMON */
	// qd-include ./web/JS/components/JS.rda.rda.functions.common.js

	/* HOME */
	// qd-include ./web/JS/components/JS.rda.rda.functions.home.js	

	/* SEARCH */
	// qd-include ./web/JS/components/JS.rda.rda.functions.search.js

	/* PRODUCT */
	// qd-include ./web/JS/components/JS.rda.rda.functions.product.js

	/* LIST */
	// qd-include ./web/JS/components/JS.rda.rda.functions.list.js

	/* INSTITUCIONAL */
	// qd-include ./web/JS/components/JS.rda.rda.functions.institucional.js

	/* ORDERS */
	// qd-include ./web/JS/components/JS.rda.rda.functions.orders.js
}
...
// qd-include web/JS/JS.lazyload.js
