...
/* LAPTOP-KBFKB1T5 - 17/11/2021 14:15:54 GMT */
  ...
  'function' !== typeof c.fn.QD_infinityScroll && (window._QuatroDigital_InfinityScroll = window._QuatroDigital_InfinityScroll || {}, c.fn.QD_infinityScroll = function (f) {
    var a = window._QuatroDigital_InfinityScroll,
      ...
      if ('object' === (typeof console === "undefined" ? "undefined" : _typeof(console)) && 'undefined' !== typeof console.error && 'undefined' !== typeof console.info && 'undefined' !== typeof console.warn) {
        var b;
        'object' === _typeof(a) ? (a.unshift('[Infinity Scroll]\n'), b = a) : b = ['[Infinity Scroll]\n' + a];
      ...
      getShelfHeight: function getShelfHeight(a) {
        return a.scrollTop() + a.height();
      },
      paginate: null,
      insertContent: function insertContent(a, b) {
        a.after(b);
      },
    ...
    1 < b.length && (e('Identifiquei que a seletor informado (' + b.selector + ') retornou ' + b.length + " elementos.\n Para solucionar o problema estou selecionando autom\xE1ticamente o primeiro com o id: #" + (b.filter('[id^=ResultItems]:first').attr('id') || '!Not Found'), 'Aviso'), b = b.filter('[id^=ResultItems]:first'));
    b.filter('[id^=ResultItems]').length || e(["Certifique-se que esta selecionando o elemento correto.\n O plugin espera que o elemento seja o que cont\xE9m o id: #" + (c('div[id^=ResultItems]').attr('id') || '!Not Found'), c('div[id^=ResultItems]')], 'Info');
    b.parent().filter('[id^=ResultItems]').length && (b = b.parent(), e(["Identifiquei que o seletor pai do elemento que voc\xEA informou \xE9 o #" + (jQuery('div[id^=ResultItems]').attr('id') || '!Not Found') + ".\n Como forma de corrigir esse problema de sele\xE7\xE3o de elemento, assumirei a prateleira correta.", b], 'Aviso'));
    ...
    var r = function r() {
      ...
      if ('object' === _typeof(a) && 'undefined' !== typeof a[0]) return a[0].replace('paginaprateleira', 'buscapagina');
      e("N\xE3o foi poss\xEDvel localizar a url de busca da p\xE1gina.\n Tente adicionar o .js ao final da p\xE1gina. \n[M\xE9todo: getSearchUrl]");
      return '';
    };
    ...
    (function () {
      ...
      if ('' !== f && (a.pages = window['pagecount_' + f.split('_').pop()], 'undefined' === typeof a.pages)) for (var h in window) {
      ...
      var k = function k() {
        if (a.currentStatus) {
          ...
          if (1 > f.length) return e("\xDAltima Prateleira/Vitrine n\xE3o encontrada \n (" + f.selector + ')'), !1;
          f.after(n);
          a.currentStatus = !1;
          var g = a.currentPage;
          c.ajax({
            ...
            success: function success(b) {
              1 > b.trim().length ? (a.moreResults = !1, e("N\xE3o existem mais resultados a partir da p\xE1gina: " + g, 'Aviso'), c(window).trigger('QuatroDigital.is_noMoreResults')) : d.insertContent(f, b);
              a.currentStatus = !0;
              n.remove();
            },
            error: function error() {
              e("Houve um erro na requisi\xE7\xE3o Ajax de uma nova p\xE1gina.");
            },
      ...
      if ('function' === typeof d.paginate) d.paginate(function () {
        ...
        m.bind('scroll.QD_infinityScroll_paginate', function () {
          ...
          l = setTimeout(function () {
            //REQUISITA AS PROXIMAS PRATELEIRAS
