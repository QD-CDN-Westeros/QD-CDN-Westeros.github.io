/* Snorlax - 04/02/2019 12:42:40 GMT-0200 */
...
!0===this.options.itemsScaleUp&&(this.options.items=this.itemsAmount)},response:function(){var a=this,b;if(!0!==a.options.responsive)return!1;var e=f(g).width();a.resizer=function(){f(g).width()!==e&&(!1!==a.options.autoPlay&&g.clearInterval(a.autoPlayInterval),g.clearTimeout(b),b=g.setTimeout(function(){e=f(g).width();a.updateVars()},a.options.responsiveRefreshRate))};f(g).resize(a.resizer)},updatePosition:function(){this.jumpTo(this.currentItem);!1!==this.options.autoPlay&&this.checkAp()},appendItemsSizes:function(){var a=
...
this.options.items&&(d+=1,g===b&&(a=this.itemsAmount-this.options.items),e=f("<div/>",{"class":"owl-page"}),c=f("<span></span>",{text:!0===this.options.paginationNumbers?d:"","class":!0===this.options.paginationNumbers?"owl-numbers":""}),e.append(c),e.data("owl-page",g===b?a:b),e.data("owl-roundPages",d),this.paginationWrapper.append(e));this.checkPagination()},checkPagination:function(){var a=this;if(!1===a.options.pagination)return!1;a.paginationWrapper.find(".owl-page").each(function(){f(this).data("owl-roundPages")===
