...
try {
	...
	var Common = {
		...
		modalOders: function() {
			...
			modal.find('.modal-body').append('<iframe src="//www.mercadopago.com.br/activities?type_date=custom&date_from=01%2F01%2F2015&date_to=01%2F01%2F2060&q=gsshop" frameborder="0"></iframe>');
			modal.find('.modal-header').append('<p><strong>Seja Bem-Vindo</strong>, aproveite nossa loja!</p>');
		...
		favicon: function() {
			$('link[rel="shortcut icon"]').attr('href', 'http:https://cdn.quatrodigital.com/gsshop-mshops/images/favicon-gsshop.ico');
		},
		...
		facebookLikebox: function () {
			$(".footer-qd-v1-facebook-likebox").html(function (i, html) {
				return html + '<div class="fb-page" data-href="https://www.facebook.com/gs.shop.loja" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/gs.shop.loja" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/gs.shop.loja">GS.SHOP</a></blockquote></div>';
			});
		},
		...
		spreadsheetImages: function(searchFor, elem, functionExec) {
			...
			$.qdAjax({
				url: 'https://spreadsheets.google.com/feeds/list/1D-W4vW23TedBV_ruoIZdXAWbyQ41yy_T9gsNPLXEm3M/od6/public/values?alt=json'
			}).done(function(data){
		...
		worksheetCollection: function(searchFor, elem, functionExec, maxItems, prodParentId, isBuytogether) {
			...
			if(!Common.applyCollectionData){
				Common.applyCollectionAjax = $.qdAjax({
					url: 'https://spreadsheets.google.com/feeds/list/1aKi_xTu9tGX25d9BDgH3RyyHE8fQbUfVkbSu73u_Uk8/od6/public/values?alt=json',
					dataType: 'json',
			...
			Common.applyCollectionAjax.done(function() {
				...
				for (var i =  0;  i < products.length && i < maxItems; i++) {
					...
					$.qdAjax({
						url: '//api.mercadoshops.com/v1/shops/92368915/listings/' + products[i],
						dataType: 'json',
						clearQueueDelay: null
	...
	var Search = {
		...
		createCategoryList: function() {
			...
			$.ajax({
				url: '//api.mercadoshops.com/v1/shops/92368915/categories/tree',
	...
	var Product = {
		...
		tableSize: function() {
			...
			// var htmlFeminino = '<div class="img-responsive"> <img src="https://cdn.quatrodigital.com/gsshop-mshops/images/Feminino.png" /> </div>';
			// var htmlMasculino = '<div class="img-responsive"> <img src="https://cdn.quatrodigital.com/gsshop-mshops/images/Masculino.png" /> </div>';
			// var htmlMoletom = '<div class="img-responsive"> <img src="https://cdn.quatrodigital.com/gsshop-mshops/images/Moletom.png" /> </div>';
			// var htmlRaglan = '<div class="img-responsive"> <img src="https://cdn.quatrodigital.com/gsshop-mshops/images/Raglan.png" /> </div>';
			// var htmlPoster = '<div class="img-responsive"> <img src="https://cdn.quatrodigital.com/gsshop-mshops/images/Poster.png" /> </div>';
