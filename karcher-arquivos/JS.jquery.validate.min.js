/* LAPTOP-P1JOF4DF - 20/08/2019 14:38:59 GMT */
/*
...
":submit",function(a){b.submitButton=a.currentTarget;c(this).hasClass("cancel")&&(b.cancelSubmit=!0);void 0!==c(this).attr("formnovalidate")&&(b.cancelSubmit=!0)}),this.on("submit.validate",function(a){function d(){var d,e;return b.submitButton&&(b.settings.submitHandler||b.formSubmitted)&&(d=c("<input type='hidden'/>").attr("name",b.submitButton.name).val(c(b.submitButton).val()).appendTo(b.currentForm)),!b.settings.submitHandler||(e=b.settings.submitHandler.call(b,b.currentForm,a),d&&d.remove(),
void 0!==e&&e)}return b.settings.debug&&a.preventDefault(),b.cancelSubmit?(b.cancelSubmit=!1,d()):b.form()?b.pendingRequest?(b.formSubmitted=!0,!1):d():(b.focusInvalid(),!1)})),b)},valid:function(){var a,b,d;return c(this[0]).is("form")?a=this.validate().form():(d=[],a=!0,b=c(this[0].form).validate(),this.each(function(){(a=b.element(this)&&a)||(d=d.concat(b.errorList))}),b.errorList=d),a},rules:function(a,b){var d,e,f,h,g,l,k=this[0];if(null!=k&&(!k.form&&k.hasAttribute("contenteditable")&&(k.form=
this.closest("form")[0],k.name=this.attr("name")),null!=k.form)){if(a)switch(d=c.data(k.form,"validator").settings,e=d.rules,f=c.validator.staticRules(k),a){case "add":c.extend(f,c.validator.normalizeRule(b));delete f.messages;e[k.name]=f;b.messages&&(d.messages[k.name]=c.extend(d.messages[k.name],b.messages));break;case "remove":return b?(l={},c.each(b.split(/\s/),function(a,b){l[b]=f[b];delete f[b]}),l):(delete e[k.name],f)}return h=c.validator.normalizeRules(c.extend({},c.validator.classRules(k),
c.validator.attributeRules(k),c.validator.dataRules(k),c.validator.staticRules(k)),k),h.required&&(g=h.required,delete h.required,h=c.extend({required:g},h)),h.remote&&(g=h.remote,delete h.remote,h=c.extend(h,{remote:g})),h}}});c.extend(c.expr.pseudos||c.expr[":"],{blank:function(a){return!c.trim(""+c(a).val())},filled:function(a){a=c(a).val();return null!==a&&!!c.trim(""+a)},unchecked:function(a){return!c(a).prop("checked")}});c.validator=function(a,b){this.settings=c.extend(!0,{},c.validator.defaults,
...
this.errors().add(this.containers)},prepareElement:function(a){this.reset();this.toHide=this.errorsFor(a)},elementValue:function(a){var b,d,e=c(a),f=a.type;return"radio"===f||"checkbox"===f?this.findByName(a.name).filter(":checked").val():"number"===f&&"undefined"!=typeof a.validity?a.validity.badInput?"NaN":e.val():(b=a.hasAttribute("contenteditable")?e.text():e.val(),"file"===f?"C:\\fakepath\\"===b.substr(0,12)?b.substr(12):(d=b.lastIndexOf("/"),0<=d?b.substr(d+1):(d=b.lastIndexOf("\\"),0<=d?b.substr(d+
1):b)):"string"==typeof b?b.replace(/\r/g,""):b)},check:function(a){a=this.validationTargetFor(this.clean(a));var b,d,e,f=c(a).rules(),h=c.map(f,function(a,b){return b}).length,g=!1,l=this.elementValue(a);if("function"==typeof f.normalizer?e=f.normalizer:"function"==typeof this.settings.normalizer&&(e=this.settings.normalizer),e){if(l=e.call(a,l),"string"!=typeof l)throw new TypeError("The normalizer should return a string value.");delete f.normalizer}for(d in f){e={method:d,parameters:f[d]};try{if(b=
c.validator.methods[d].call(this,l,a,e.parameters),"dependency-mismatch"===b&&1===h)g=!0;else{if(g=!1,"pending"===b)return void(this.toHide=this.toHide.not(this.errorsFor(a)));if(!b)return this.formatAndAdd(a,e),!1}}catch(k){throw this.settings.debug&&window.console&&console.log("Exception occurred when checking element "+a.id+", check the '"+e.method+"' method.",k),k instanceof TypeError&&(k.message+=".  Exception occurred when checking element "+a.id+", check the '"+e.method+"' method."),k;}}if(!g)return this.objectLength(f)&&
...
findByName:function(a){return c(this.currentForm).find("[name='"+this.escapeCssMeta(a)+"']")},getLength:function(a,b){switch(b.nodeName.toLowerCase()){case "select":return c("option:selected",b).length;case "input":if(this.checkable(b))return this.findByName(b.name).filter(":checked").length}return a.length},depend:function(a,b){return!this.dependTypes[typeof a]||this.dependTypes[typeof a](a,b)},dependTypes:{"boolean":function(a){return a},string:function(a,b){return!!c(a,b.form).length},"function":function(a,
...
(c(this.currentForm).submit(),this.submitButton&&c("input:hidden[name='"+this.submitButton.name+"']",this.currentForm).remove(),this.formSubmitted=!1):!b&&0===this.pendingRequest&&this.formSubmitted&&(c(this.currentForm).triggerHandler("invalid-form",[this]),this.formSubmitted=!1)},previousValue:function(a,b){return b="string"==typeof b&&b||"remote",c.data(a,"previousValue")||c.data(a,"previousValue",{old:null,valid:!0,message:this.defaultMessage(a,{method:b})})},destroy:function(){this.resetForm();
...
h,b,d);return e.maxlength&&/-1|2147483647|524288/.test(e.maxlength)&&delete e.maxlength,e},dataRules:function(a){var b,d={},e=c(a),f=a.getAttribute("type");for(b in c.validator.methods)a=e.data("rule"+b.charAt(0).toUpperCase()+b.substring(1).toLowerCase()),this.normalizeAttributeRule(d,f,b,a);return d},staticRules:function(a){var b={},d=c.data(a.form,"validator");return d.settings.rules&&(b=c.validator.normalizeRule(d.settings.rules[a.name])||{}),b},normalizeRules:function(a,b){return c.each(a,function(d,
e){if(!1===e)return void delete a[d];if(e.param||e.depends){var f=!0;switch(typeof e.depends){case "string":f=!!c(e.depends,b.form).length;break;case "function":f=e.depends.call(b,b)}f?a[d]=void 0===e.param||e.param:(c.data(b.form,"validator").resetElements(c(b)),delete a[d])}}),c.each(a,function(d,e){a[d]=c.isFunction(e)&&"normalizer"!==d?e(b):e}),c.each(["minlength","maxlength"],function(){a[this]&&(a[this]=Number(a[this]))}),c.each(["rangelength","range"],function(){var b;a[this]&&(c.isArray(a[this])?
...
success:function(c){var d,g,h,k=!0===c||"true"===c;f.settings.messages[b.name][e]=l.originalMessage;k?(h=f.formSubmitted,f.resetInternals(),f.toHide=f.errorsFor(b),f.formSubmitted=h,f.successList.push(b),f.invalid[b.name]=!1,f.showErrors()):(d={},g=c||f.defaultMessage(b,{method:e,parameters:a}),d[b.name]=l.message=g,f.invalid[b.name]=!0,f.showErrors(d));l.valid=k;f.stopRequest(b,k)}},d)),"pending")}}});var n,m={};return c.ajaxPrefilter?c.ajaxPrefilter(function(a,b,c){b=a.port;"abort"===a.mode&&(m[b]&&
m[b].abort(),m[b]=c)}):(n=c.ajax,c.ajax=function(a){var b=("port"in a?a:c.ajaxSettings).port;return"abort"===("mode"in a?a:c.ajaxSettings).mode?(m[b]&&m[b].abort(),m[b]=n.apply(this,arguments),m[b]):n.apply(this,arguments)}),c});