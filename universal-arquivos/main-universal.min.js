...
var commonFunctions = {
      ...
      $(".custom-search__result").append(
        $("<div>", {
          ...
          $("<h3>", {
            ...
            text: "NÃ£o encontramos produtos para",
          }),
          $("<h2>", {
  ...
  //troca a classe do body quando o produto estÃ¡ fora de estoque
  ...
  //caso produto nÃ£o esteja em estoque tira o botÃ£o qtd e esconde o comprar
  ...
  isLogged: function () {
    ...
    vtexjs.checkout.getOrderForm().done(function (data) {
      ...
      if (data.loggedIn) {
        ...
        $(".menu__user-item > a ").text("OlÃ¡, " + userName);
  ...
  newsletterClk: () => {
    $(".js--newsletter").on("click", ({ currentTarget }) => {
      if ($('.row-news input[type="email"]').val() !== "") {
        ...
        alert("Ã© necessÃ¡rio digitar o e-mail");
      }
    });
  },
  ...
  newsletterSign: (email) => {
    $(".js--sign-newsletter").on("click", (e) => {
      ...
      if (!$checkedGenre.length && inputValidate.hasClass("invalid")) {
        alert(
          "Por favor, selecione um gÃªnero musical e insira seu nome completo"
        );
      }
...
var catalog = {
  ...
  departementNavigator: function () {
    if ($("ul.productClusterSearchableIds").size() > 0) {
      ...
      templateCluster +=
        '<div class="acordeon-start"><h6> ColeÃ§Ãµes <span><i class="ico-arrow"></i> </span></h6></div>';
  ...
  catalgoHelper: function () {
    if (IS_SEARCH) {
      ...
      var template =
        "<span>VocÃª buscou por:</span> <strong>â€œ" +
        keyWord +
        "â€</strong><small>Encontramos <b>" +
        num +
        "</b> resultados</small>";
...
var product = {
  ...
  installmentToggle: function () {
    ...
    var templateAvista =
      '<div class="left">Ã  vista</div><div class="right">R$ ' +
      price +
      "</div>";
    ...
    $(".prodQtd span").on("click", function () {
      ...
      if (SKU != undefined) {
        ...
        if (_this.hasClass("removeItem")) {
          ...
          if (qtl >= max) {
            qtl = max;
            alert("Quantidade mÃ¡xima disponÃ­vel atingida.");
          } else {
            qtl++;
          }
        }
  ...
  producUnavailable: function () {
    if (!skuJson.available) {
      ...
      $(".notifymetitle").text("AVISE-ME: ESTE PRODUTO ESTÃ INDISPONÃVEL");
                    ...
                    <div class="wrapper">
                        <div class="content">
                            <div class='buy-together-titles'>
                                <h3 class='first-title'>VOCÃŠ ESTÃ VENDO</h3>
...
var institutional = {
  ...
  _setExchangeDate() {
    ...
    const orderExchangeDateHour = `${day}/${formatedMonth}/${year} Ã¡s ${formatedHour}:${min}`;
...
var account = {
  ...
  cancelBtn: function () {
    $("body").on("click", ".myo-cancel-btn", function (e) {
      e.preventDefault();
      alert(
        "Para solicitar o cancelamento do seu pedido entre em contato com nosso SAC atravÃ©s do e-mail contato@umusicstore.com ou pelo telefone (21) 3030-4042"
      );
    });
  },
  ...
  insertExchangeAndReturn: function () {
    $('.vtex-account_menu-link[href="#/orders"]').after(
      `<a class="vtex-account_menu-link f6 no-underline db hover-near-black pv5 mv3 pl5 bl bw2 nowrap c-muted-1 b--transparent" href="/Institucional/trocas-e-devolucoes">Trocas e devoluÃ§Ãµes</a>`
    );
  },
};
